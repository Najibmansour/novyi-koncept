...
const vecs = [
  ...
  },
  {
    ...
    points: [
      ...
      "<p>На основе этого дадим рекомендации, как рассчитать действительно выгодную цену за 1 единицу товара </p><p>А так же - какой бюджет надо заложить в продвижение, чтобы товар вышел в ТОП.</p>",
    ],
    dir: "left",
    vec: Vector1,
  },
  ...
  },
  {
    ...
    points: [
      ...
      ,
      "Еженедельный анализ и корректировки рекламных кампаний.",
      ,
