...
const vecs = [
  ...
  },
  {
    ...
    points: [
      ...
      `На основе этого дадим рекомендации, как рассчитать действительно выгодную цену за 1 единицу товара.<br/> А так же - какой бюджет надо заложить в продвижение, чтобы товар вышел в ТОП`,
    ],
    dir: "left",
    vec: Vector1,
  },
