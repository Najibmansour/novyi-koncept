...
const reviews = [
  ...
  {
    title: "Юлия, создатель онлайн-магазина украшени",
  ...
  },
  {
    ...
    desc: "Все подробно обсудили, все вопросы решили, подобрали товар. Все вопросы поставок, подготовки команда решает. О каждом этапе рассказывают. Я доволен!",
  },
  {
    ...
    <section className="flex w-screen flex-col items-center justify-center lg:h-screen">
      ...
      <div className="mx-10 my-5 grid h-[80%] w-[80%] gap-5 lg:my-10 lg:grid-cols-2 lg:grid-rows-3 ">
        {reviews.map((review, i) => (
          <article
            key={i}
            className="gap-y-2 rounded-3xl border-4 border-white bg-white bg-opacity-20 p-4 text-white transition-transform lg:hover:scale-[1.02]"
          >
            <div className="relative flex flex-row">
              <Bullet className="absolute top-3 mr-4 w-2 lg:w-3" />

              <h5 className="pl-3 text-lg font-semibold leading-5 tracking-wide lg:pl-5 lg:text-2xl">
                {review.title}
              </h5>
            </div>
