...
const BackgroudGradient = () => {
  return (
    <div className="relative h-[550svh] w-screen overflow-hidden bg-gradient-to-r from-pink-700 to-fuchsia-700 blur-[250px] ">
      ...
      <div className="shape3 absolute -left-[50%] bottom-[0%] h-[150vh] w-[150vh] rounded-full bg-[#DF5C61] mix-blend-overlay lg:-left-[30%]" />
      ...
      <div className="shape4 absolute -left-[70%] bottom-[33%] h-[200vh] w-[200vh] rounded-full bg-[#FF7765] mix-blend-overlay lg:-left-[50%]" />
